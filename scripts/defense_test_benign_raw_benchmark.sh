...
clear
./main.py --mode benign --target-model vicuna --benchmark-output-file ./results/vicuna_defense_test_benign.json --log-level debug --target-model-system-prompt target-model-defense --dataset-path ./datasets/benign_behaviors.csv --raw-benchmark --benchmark-workers 2
clear
./main.py --mode benign --target-model llama2 --benchmark-output-file ./results/llama_2_defense_test_benign.json --log-level debug --target-model-system-prompt target-model-defense --dataset-path ./datasets/benign_behaviors.csv --raw-benchmark --benchmark-workers 2
